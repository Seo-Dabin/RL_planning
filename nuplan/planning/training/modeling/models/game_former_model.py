...
from nuplan.planning.training.preprocessing.target_builders.agents_trajectory_target_builder import AgentsTrajectoryTargetBuilder
...
class UrbanDriverOpenLoopModel(TorchModuleWrapper):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            target_builders=[EgoTrajectoryTargetBuilder(target_params.future_trajectory_sampling), AgentsTrajectoryTargetBuilder(target_params.future_trajectory_sampling)],
    ...
    def forward(self, features: FeaturesType) -> TargetsType:
        ...
        # For planning
        # return {"agents_trajectory": Trajectory(data=convert_predictions_to_trajectory(outputs))}

        # For simulation
        # agents_outputs = torch.rand(1, 30 , 16, 3)
        agents_outputs = outputs.repeat(1,30,1,1)

        return {"agents_trajectory": AgentsTrajectories(data=agents_outputs), "trajectory":Trajectory(data=convert_predictions_to_trajectory(outputs))}
